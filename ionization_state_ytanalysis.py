...
def rahuls_function(simulation,filename,redshift):
    ...
    dir = 'ion_state_ytanalysis/' + simulation + "_" + str(redshift)
    if os.path.exists(dir):
      shutil.rmtree(dir)
    os.makedirs(dir)
    ...
    f.write("OI values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OI.png')))
    f.write("\n \n OII values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OII.png')))
    f.write("\n \n OIII values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OIII.png')))
    f.write("\n \n OIV values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OIV.png')))
    f.write("\n \n OV values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OV.png')))
    f.write("\n \n OVI values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OVI.png')))
    f.write("\n \n OVII values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OVII.png')))
    f.write("\n \n OVIII values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OVIII.png')))
    f.write("\n \n OIX values: ")
    f.write(str(extract_colors('ion_state_ytanalysis/O_num_density_plots/OIX.png')))
    f.close()
