...
def rahuls_function(simulation,filename,redshift):
    ...
    f.write("OI values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OI.png')))
    f.write("\n \n OII values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OII.png')))
    f.write("\n \n OIII values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OIII.png')))
    f.write("\n \n OIV values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OIV.png')))
    f.write("\n \n OV values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OV.png')))
    f.write("\n \n OVI values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OVI.png')))
    f.write("\n \n OVII values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OVII.png')))
    f.write("\n \n OVIII values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OVIII.png')))
    f.write("\n \n OIX values: ")
    f.write(str(extract_colors('O_num_density_plots/ion_state_ytanalysis/OIX.png')))
    f.close()
