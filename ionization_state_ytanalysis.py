...
def rahuls_function(simulation,filename,redshift):
    ...
    proj_OII = remove_extraneous(proj)
    # proj_OII.show()
    proj_OII.save('OII.png')
    ...
    proj_OIII = remove_extraneous(proj)
    # proj_OIII.show()
    proj_OIII.save('OIII.png')
    ...
    proj_OIV = remove_extraneous(proj)
    # proj_OIV.show()
    proj_OIV.save('OIV.png')
    ...
    proj_OV = remove_extraneous(proj)
    # proj_OV.show()
    proj_OV.save('OV.png')
    ...
    proj_OVI = remove_extraneous(proj)
    # proj_OVI.show()
    proj_OVI.save('OVI.png')
    ...
    proj_OVII = remove_extraneous(proj)
    # proj_OVII.show()
    proj_OVII.save('OVII.png')
    ...
    proj_OVIII = remove_extraneous(proj)
    # proj_OVIII.show()
    proj_OVIII.save('OVIII.png')
    ...
    proj_OIX = remove_extraneous(proj)
    # proj_OIX.show()
    proj_OIX.save("OIX.png")
