...
srun -n 32 -u python -u quasarscan/get_coldens.py -fn quasarscan/output2.0/VELA$v${i}coldensinfo/${n}_of_416-_OI_OII_OIII_OIV_OV_OVI_OVII_OVIII_OIX_HI_HII_z$z.txt -s 96 -p
